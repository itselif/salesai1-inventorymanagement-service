...
describe("InventoryManagementShareTokenManager", () => {
  let ManagerClass;
  let manager;
  let req;
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/InventoryManagementShareToken/InventoryManagementShareTokenManager",
      {
        "../../service-manager/InventoryManagementServiceManager": class {
          constructor() {
